...
class PaymentScreenFirst extends React.Component {
  state = {
        ...
        <View style={{ flex: 1 }}>
          <ScrollView style={{flex: 1 ,padding:10, backgroundColor:"black"}}>
            <View style={{margin:20}}>
              ...
              >
                <Text style={{color:"white", fontFamily:"Poppins-Light", fontWeight:"bold", paddingRight:20, paddingBottom:20}}>Trial Offer</Text>
              </TouchableOpacity>
              <Text style={{color:"#42B649", fontFamily:"Poppins-Light", paddingBottom:20, textTransform:"uppercase"}}>Introductory Trial Offer</Text>
              <Text style={{color:"white", fontFamily:"Poppins-Light", paddingRight:20, paddingBottom:20}}>Watch and enjoy any 2 videos on Mittu for FREE.</Text>
              <Text style={{color:"white", marginTop:10, marginBottom:10 , fontSize:22, fontWeight:"bold", fontFamily:"Poppins-Light", paddingRight:15, paddingBottom:15}}>OR</Text>
              <View
                style={{
              ...
              />
              <Text style={{color:"white", fontFamily:"Poppins-Light", paddingTop:40, paddingBottom:30, fontSize:28, fontWeight:'bold'}}>Choose Your Plan</Text>
              <TouchableOpacity
                onPress={() => {
              ...
              >
                <Text style={{margin:"auto", textAlignVertical: "center",textAlign: "center", color:"white", fontWeight:"bold", fontFamily:"Poppins-Light", }}>SKIP <Icon name="chevron-right" color="white"/></Text>
              </TouchableOpacity>
            </View>
          </ScrollView>
        </View>
...
export default PaymentScreenFirst;
