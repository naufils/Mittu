            ...
            {!this.state.loading ? 
              ...
              <Header
                ...
                <View style={{marginTop:25, padding:30}}>
                    ...
                    <Text style={{fontSize:16,color:'white', fontFamily:'OpenSans-Bold', marginBottom:10}}>
                    ...
                    <Text style={{fontSize:16,color:'white', fontFamily:'OpenSans-Bold', marginBottom:10}}>
                        We have provided extensive information for you to view the packages before choosing to subscribe to us. If you have any questions or reservations, please contact us at info.hometheatreapp@gmail.com prior to subscribing to our services. 
                    </Text>
