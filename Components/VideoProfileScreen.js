...
import { Text, View, StyleSheet, Image, TouchableOpacity, ScrollView,SafeAreaView, BackHandler, Dimensions, StatusBar } from 'react-native';
          ...
          <View style={styles.container}>
            <View style={{padding:0}}>
              <TouchableOpacity onPress={() => this.onPressVideo(this.state.VideoData.vid_location)}>
                <Image width={deviceWidth} height={300} source={{uri: this.state.VideoData.vid_thumbs}} />
                <View style={{position:'absolute', marginLeft:'43%', marginTop:90}}><Image source={PlayIcon} style={{position:'absolute', opacity:1}}  width={70} height={70}/></View>
              </TouchableOpacity>
            </View>  

            <View style={{padding:5}}>
              <Text style={{paddingBottom:10, paddingTop:10, fontFamily:'OpenSans-Bold', fontSize:16, marginLeft:10, color:'white'}}>{this.state.VideoData.vid_name}</Text>
            ...
            <View style={{padding:10, paddingLeft:15, alignItems:'center', flexWrap:'wrap'}}>
              <Text style={{fontFamily:'OpenSans-Regular',fontSize:14,color:'white'}}>{this.state.VideoData.vid_desc}</Text>
            </View>
          </View>
        </ScrollView>   
        </SafeAreaView>  
