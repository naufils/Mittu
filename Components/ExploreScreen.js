    ...
    if (this.state.searchItem.length !== 0) {
      ...
      if (this.state.searchResult) {
        ...
        images1 = this.state.renderItems1.map((item, i) => {
          return (
            <View
              style={{ paddingLeft: 5, paddingRight: 1, width: 114 }}
              key={i}
            >
              <TouchableOpacity onPress={() => this.onPressImage(item)}>
                <Image
    ...
    return (
      ...
      >
        ...
        <View style={styles.container}>
          ...
          {this.state.cat && this.state.searchResult === false ? null : this
            ...
            >
              <ScrollView horizontal>{images1}</ScrollView>
            </View>
          )}
            ...
            <FlatList
              ...
              renderItem={({ item, index, separators }) => (
                <View style={{ flex: 1 / 3, paddingBottom: 10 }}>
                  <TouchableOpacity
                    onPress={() => this.onCatHandler(item.subcat_id)}
                    key={index}
                  >
                    <Text
                      style={{
