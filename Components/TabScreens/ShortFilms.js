...
class ShortFilms extends React.Component {
  ...
  componentDidMount(){
    ...
    return fetch(config.localhost_url+'/fetch-shortFilms', {
      method: 'GET',
      headers: {
          ...
          <View style={{ flex: 1, flexDirection:'column', alignItems: 'flex-start', backgroundColor:'#121212', marginBottom:10, marginTop:10}} key={i}>     
            ...
            <FlatList
              ...
              renderItem={({item, index, separators}) => (
                <View style={{paddingLeft:5, paddingRight:1, marginTop:1, flexDirection:'row', marginRight:5, width:114}} key={i}>
