...
export default class LoginButton extends Component {
  ...
  render() {
    ...
    let indicator = (<Text uppercase={false} style={{fontFamily:'OpenSans-Regular', color: loginColor, fontWeight: '500', fontSize: GLOBAL.totalSize(2.22) }}>{language.login}</Text>);
    if (this.state.isLogin) {
